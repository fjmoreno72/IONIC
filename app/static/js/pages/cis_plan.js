...
// Store security classifications data
    ...
    async function addSecurityDomain() {
        ...
        if (cisPlanData && cisPlanData.missionNetworks && Array.isArray(cisPlanData.missionNetworks)) {
            // First find the segment in our data
            const missionNetwork = cisPlanData.missionNetworks.find(mn => mn.id === missionNetworkId);
