...
def manage_config_items():
    ...
    """
    # Path to the configuration items JSON file (using current_app.static_folder)
    config_items_path = Path(current_app.static_folder) / "ASC" / "data" / "configItem.json" # Corrected path
