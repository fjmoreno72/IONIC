...
from ionic2.api.client import ApiClient
from ionic2.core.exceptions import ApiRequestError, InvalidSession, DataFormatError
from ionic2.config import settings
from ionic2.utils.file_operations import write_json_file, write_markdown_file
...
class IOCore2ApiClient(ApiClient):
    ...
    def get_ier_coverage(self, output_path: Optional[str] = None) -> Dict[str, Any]:
        """
        Get IER coverage data from IOCore2.
        
        Args:
            output_path: Optional path to save the JSON data
        ...
        try:
            ...
            if output_path:
                json_file_path = f"{output_path}/IER.json"
                markdown_file_path = f"{output_path}/IER.md"
                
                # Save JSON data
                write_json_file(data, json_file_path)
                
                # Process and save markdown
                from ionic2.data.ier_analysis import analyze_ier_data, generate_ier_markdown_output
    ...
    def get_requirement_coverage(self, output_path: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Save to file if output path provided
            if output_path:
                json_file_path = f"{output_path}/SREQ.json"
                markdown_file_path = f"{output_path}/SREQ.md"
                
                # Save JSON data
                write_json_file(data, json_file_path)
                
                # Process and save markdown
                from ionic2.data.sreq_analysis import extract_null_testcase_entries, organize_hierarchical_data, generate_markdown
    ...
    def get_test_cases(self, output_path: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Save to file if output path provided
            if output_path:
                json_file_path = f"{output_path}/test_cases.json"
                write_json_file(data, json_file_path)
    ...
    def get_test_results(self, output_path: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Save to file if output path provided
            if output_path:
                json_file_path = f"{output_path}/test_results.json"
                write_json_file(data, json_file_path)
    ...
    def get_patterns(self, output_path: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Save to file if output path provided
            if output_path:
                json_file_path = f"{output_path}/pattern.json"
            ...
            if output_path:
                ...
                # Re-raise if we can't create a file
                raise
    ...
    def get_actors(self, output_path: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Save to file if output path provided
            if output_path:
                json_file_path = f"{output_path}/actors.json"
